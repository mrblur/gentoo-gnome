...
RDEPEND="
	...
	>=gnome-extra/gnome-calculator-3.28.0
	>=gnome-extra/gnome-calendar-${PV}
	>=gnome-extra/gnome-characters-3.28.0
	>=sys-apps/gnome-disk-utility-3.28.0
	>=media-gfx/gnome-font-viewer-3.28.0
	>=gnome-extra/gnome-system-monitor-3.28.0
	...
	>=gnome-extra/gnome-tweak-tool-3.24
